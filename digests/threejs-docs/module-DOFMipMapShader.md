<!-- ingested from https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/module-DOFMipMapShader.html.md (direct markdown, no model) -->

# DOFMipMapShader

## Import

DOFMipMapShader is an addon, and must be imported explicitly, see [Installation#Addons](https://threejs.org/manual/#en/installation).
