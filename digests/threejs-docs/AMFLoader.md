<!-- ingested from https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/AMFLoader.html via dry-run -->

# AMFLoader

Source: https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/AMFLoader.html
