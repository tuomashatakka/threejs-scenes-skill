<!-- ingested from https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/module-VelocityShader.html.md (direct markdown, no model) -->

# VelocityShader

## Import

VelocityShader is an addon, and must be imported explicitly, see [Installation#Addons](https://threejs.org/manual/#en/installation).
