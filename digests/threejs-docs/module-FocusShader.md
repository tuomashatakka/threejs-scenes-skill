<!-- ingested from https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/module-FocusShader.html.md (direct markdown, no model) -->

# FocusShader

## Import

FocusShader is an addon, and must be imported explicitly, see [Installation#Addons](https://threejs.org/manual/#en/installation).
