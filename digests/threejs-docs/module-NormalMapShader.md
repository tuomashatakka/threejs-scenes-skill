<!-- ingested from https://raw.githubusercontent.com/mrdoob/three.js/dev/docs/pages/module-NormalMapShader.html.md (direct markdown, no model) -->

# NormalMapShader

## Import

NormalMapShader is an addon, and must be imported explicitly, see [Installation#Addons](https://threejs.org/manual/#en/installation).
