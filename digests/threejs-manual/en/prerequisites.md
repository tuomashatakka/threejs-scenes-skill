<!-- ingested from https://threejs.org/manual/en/prerequisites.html (direct markdown, no model) -->
...
function closes over the variable foo . Here's more info . 
...
```
 ...
 Arrays added the functions forEach ,
 map , and
 filter and
...
JavaScript. Many linters , programs that check for obvious errors in your code,
...
using Visual Studio Code for JavaScript and
...
bugs in your JavaScript. 
 Some examples 
 If you enable the no-undef rule then
...
and transpile the code back to pre ES5 Javascript .
