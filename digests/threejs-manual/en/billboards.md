<!-- ingested from https://threejs.org/manual/en/billboards.html (direct markdown, no model) -->

Billboards 

 In a previous article we used a CanvasTexture 
...
other things that always face the camera. Three.js provides the Sprite and
 ...
 Let's change the badge example from the article on canvas textures 
...
in the article on render targets . 
...
we did in the article on loading a .obj file 
with a few minor changes. 
 We call frameArea again adapted the article on loading a .obj file .
