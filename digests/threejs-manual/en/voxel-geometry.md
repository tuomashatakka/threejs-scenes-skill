<!-- ingested from https://threejs.org/manual/en/voxel-geometry.html (direct markdown, no model) -->
...
it's likely too slow. Like the article on how to optimize lots of objects 
the problem is there are just way too many objects. 256x256
is 65536 boxes! 
 Using the technique of merging the geometry 
...
```
 ...
 Searching on the net I found this set 
of CC-BY-NC-SA licensed minecraft textures
by Joshtimus .
I picked a few at random and built this texture atlas . 
...
made in the article on picking 
...
Instead I found a voxel specific raycaster .
