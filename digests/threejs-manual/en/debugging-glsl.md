<!-- ingested from https://threejs.org/manual/en/debugging-glsl.html (direct markdown, no model) -->
...
Those are really large topics. If you want to learn GLSL consider checking out
 these articles as a starting place. 
...
```
 ...
 Shader Editor extension for Chrome 
