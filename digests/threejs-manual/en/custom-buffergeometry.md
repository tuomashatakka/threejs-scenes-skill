<!-- ingested from https://threejs.org/manual/en/custom-buffergeometry.html (direct markdown, no model) -->
...
```
 ...
 BufferGeometry has a computeVertexNormals method for computing normals if you
...
The solution is to supply your own normals. 
 We can also use TypedArrays from the start instead of native JavaScript arrays.
...
sphere points. How this works is explained in the article on optimizing lots of objects . 
