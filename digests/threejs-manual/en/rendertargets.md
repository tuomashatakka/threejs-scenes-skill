<!-- ingested from https://threejs.org/manual/en/rendertargets.html (direct markdown, no model) -->
...
render target's texture is being cleared to red. 
 Render targets are used for all kinds of things. Shadows use render targets.
 Picking can use a render target . Various kinds of
 post processing effects require render targets.
