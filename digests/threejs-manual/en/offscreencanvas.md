<!-- ingested from https://threejs.org/manual/en/offscreencanvas.html (direct markdown, no model) -->
...
example from the article on responsiveness . 
...
We only need to support the features the OrbitControls need. 
 Digging through the OrbitControls source code 
