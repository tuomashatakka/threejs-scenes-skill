...
export function applyEnvironment(scene, renderer, { intensity = 1, envScene } = {}) {
...
export function createSun({ color = '#fff5e0', intensity = 3, position = new THREE.Vector3(8, 12, 6), shadowMapSize = 2048, shadowFrustum = 15, shadowFar = 30, } = {}) {
...
export function createHemisphereFill({ skyColor = '#a0c0ff', groundColor = '#3a2a1a', intensity = 0.4, } = {}) {
