// scripts/cpu-particles.js
// CPU-driven particle system using InstancedMesh + GLSL billboarding.
// Suitable for 10k–50k particles with custom physics. For larger counts use
// GPGPU ping-pong (see references/particles.md).
