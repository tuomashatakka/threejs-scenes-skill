...
// state source, wraps the shared createApp runtime (which lives in
// threejs-scenes/core), and returns the app plus its genre-specific handles.
// Subpaths also resolve individually:
