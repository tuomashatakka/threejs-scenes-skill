...
function isReactive (name: string, value: unknown): boolean {
  return typeof value === 'function' && !name.startsWith('on') && !RAW_FUNCTION_PROPS.has(name)
}

function mountChild (child: SceneChild, container: THREE.Object3D | null, rt: Runtime): void {
...
function mountElement (el: SceneElement, container: THREE.Object3D | null, rt: Runtime): void {
...
export function mountTree (root: SceneChild, rt: Runtime): void {
