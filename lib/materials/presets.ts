...
export function createStandardMaterial (
  presetOrParams: StandardPresetName | THREE.MeshStandardMaterialParameters = 'plastic',
...
export function createGradientToonMap (steps = 4): THREE.DataTexture {
 ...
 */
export function createMatcapMaterial (matcap?: THREE.Texture | string): THREE.MeshMatcapMaterial {
